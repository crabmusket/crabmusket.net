...
"Moloch!" cries Freder as he witnesses the devastation of the industrial accident.
...
We forget the _subtler_ horror depicted in that famous scene.
...
Only in their accidental maiming by the explosion do they regain their human characteristics.
...
The book explores Ellul's concept of _technique_, which he argues is a vital, and almost entirely overlooked, determinant of the course of human history.

---

_All quotes in this article are taken from John Wilkinson's 1964 translation.
Out of sympathy with Ellul's maxim that "books are made to be read and not consulted," I have provided the name of the section each quote appears in, but no page references._
...
>
> <footer>&mdash; The Technological Society (1954), "Situating the technical phenomenon"</footer>

In a technical world---most potently symbolised by the clock---humans are not the masters of their own destiny, nor even of their daily schedules.
...
>
> <footer>&mdash; "Automatism of technical choice"</footer>

By ignoring factors that are not technical---unquantifiable truths _not_ related to yield or efficiency---technique creates a new moral universe, separate from both traditional and modern humanistic ethics.
This alone might be of little concern, but technique swiftly engenders itself.
The introduction of efficiency in one place demands efficiency in adjacent areas, and so the technical moral universe expands.
Eventually it engulfs the natural moral and physical universe:
...
>
> <footer>&mdash; "The new characteristics"</footer>

This allegory using the natural environment extends to our social environment as well: one day, Ellul warns, traditional humanism will disappear and absolute efficiency will reign over the planet.
...
He seems far too romantic, imagining a bucolic past and appealing directly to a divine order for which humans were created.
...
>
> <footer>&mdash; "Modification of the milieu and space"</footer>
...
This demonstrates the effects when humans are deprived of connection to nature, and showcases the masterful use of an adaptive technique to regain lost efficiency.
For, after all: "the yield is greater when man acts from consent, rather than constraint."
...
The examples we may be familiar with in the wealthy West are less obvious.
...
This vital research has coincided with the appearance of more efficient and widespread means than ever before for _replacing_ human decision-making: fast computers.
...
Technique, as we have seen, only admits technical judgements and motivation.
...
In order that supply and demand be efficiently matched, algorithms twesk economic variables and incentives.
...
By skirting (and sometimes lobbying to actually change) employment and other regulations, on-demand economy companies strive to make labour markets efficient.
...
The most classic example may be the expanding use of coal-fired steam engines which kicked off the Western industrial revolution.
Coal-fired engines were originally used on-site at coal mines, increasing the efficiency of mining and running off the coal they helped produce.
They did such a fantastic job that coal became economic enough to supplant wood as the fuel of choice everywhere, creating the opportunity for more powerful and efficient mechanisation throughout the entire economy.

Maybe the most significant debate going on in humanity's response to climate change is over the role of geoengineering.
Should we seed the upper atmosphere with microparticles to negate the warming caused by our extractive energy industry?
...
From Ellul's pessimistic outlook, and my own techno-scepticism, you might understand that _technique_ is a force to be feared, rejected, and fought.
...
>
> <footer>&mdash; "Technique and constitution"</footer>
...
In this interconnected world, technology enables the integration of economies and societies which capital benefits from.
